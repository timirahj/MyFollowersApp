...
//  MyFollowersApp
//
//  Created by Timirah James on 4/27/17.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        //App Credentials
        Twitter.sharedInstance().start(withConsumerKey: "SXKJAkbwiESwFIoR4CuX5EvwW", consumerSecret: "sPTP9nHzhrVcFMo0XXlIAuIVZFblgE4h82oUWs6QKINOaPBjiQ")
